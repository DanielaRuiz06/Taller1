...
public class Utilities {
    public final static String [] MENU_PRINCIPAL = {"1. Adicionar un Producto", "2. Mostrar los productos","3. Mostar los productos ordenados","4. Borrar un producto de la lista"};
