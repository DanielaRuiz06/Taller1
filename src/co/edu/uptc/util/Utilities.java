...
public class Utilities {
    public final static String[] MAIN_MENU = { "Por favor, ingrese el número de la opción que desea realizar",
            "1. Adicionar un Producto", "2. Mostrar los productos", "3. Mostar los productos ordenados",
            "4. Borrar un producto de la lista", "5. Salir" };
    public final static String DELETE_MESSAGE = "Por favor, ingrese la descripcion del producto que desea eliminar:";
