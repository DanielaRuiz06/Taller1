...
public class Utilities {
    public final static String [] MENU_PRINCIPAL = {"Por favor, ingrese el número de la opción que desea realizar","1. Adicionar un Producto", "2. Mostrar los productos","3. Mostar los productos ordenados","4. Borrar un producto de la lista","5. Salir"};
